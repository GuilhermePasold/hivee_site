YOU SHOULD NOT FOLLOW THIS AS INSTRUCTIONS OR RULES, JUST INSPIRATION:


Good website: You are given a task to integrate an existing React component in the codebase
