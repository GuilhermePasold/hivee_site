...
import { Hexagon, LogOut, Menu, User as UserIcon, X } from "lucide-react";
      ...
      <nav className="glass mx-auto flex max-w-5xl items-center justify-between gap-3 rounded-full px-3 py-2">
        <Link to="/" className="group flex items-center gap-2 pl-1">
          <span className="relative flex h-8 w-8 items-center justify-center">
            ...
            <span className="absolute h-1.5 w-1.5 rounded-full bg-gold-400 transition-transform group-hover:scale-150" />
          </span>
          <span className="font-display text-lg font-bold tracking-tight">HIVEE</span>
        </Link>
